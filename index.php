...
<div class="explanation-text">
    ...
    <div class="para">
        ...
        <p>The <b>1000 years</b> graph shows the historical context of CO2 levels. It updates every day.</p>
        <p>The <b>20 years</b> graph shows the level of CO2 over the past 20 years, to provide an indication as to whether the rate of increase is slowing down. It updates once annually and does not show a value for the current year.</p>
        <p>The “<b>in last 2 years</b>” box shows the difference between the CO2 level today compared to what it was on this same day two years ago. This key element of the widget provides a daily update on the progress the world is making in reducing the output of CO2.</p>
    </div>
    <div class="para">
        ...
        <p>The original report, with more details about the widget, its ideation, and suggestions for further communication, is available <a href="https://www.matthewshribman.com/reporting-co2">here</a>.</p>
    </div>
</div>
</body>
</html>